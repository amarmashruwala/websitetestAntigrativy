            ...
            <AnimatePresence mode="popLayout">
              {filteredProjects.map((project) => (
                <motion.div
                  ...
                  className="group p-6 bg-foreground/5 dark:bg-foreground/10 border border-foreground/10 dark:border-foreground/5 rounded-xl hover:border-accent/50 transition-all duration-300"
                >
                  ...
                  <div className="flex flex-wrap gap-1 mb-3">
                    {project.tags.slice(0, 3).map((tag) => (
                      <span
                        key={tag}
                        className="px-2 py-0.5 text-xs font-mono bg-foreground/10 dark:bg-foreground/20 rounded"
                      >
                        {tag}
                      </span>
                    ))}
